...
#[inline(always)]
pub fn state(data: &mut [u8], key: &[u8]) -> Result<i64> {
    buf_write_read(data, key, _c::state)
}

/// Set the Hook State for a given key and value
#[inline(always)]
pub fn state_set(data: &[u8], key: &[u8]) -> Result<i64> {
...
#[inline(always)]
pub fn state_foreign(data: &mut [u8], key: &[u8], namespace: &[u8], accid: &[u8]) -> Result<i64> {
    let res = unsafe {
        _c::state_foreign(
...
#[inline(always)]
pub fn state_foreign_set(data: &[u8], key: &[u8], namespace: &[u8], accid: &[u8]) -> Result<i64> {
    let res = unsafe {
